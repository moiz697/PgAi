...
class DebugOptions final :
 ...
 public:
  ...
  enum : int {
    ...
    kXlaGpuEnableGpu2RuntimeFieldNumber = 233,
    kXlaGpuEnableGpu2HalFieldNumber = 234,
    ...
    kXlaGpuSingleWaveAutotuningFieldNumber = 242,
  ...
  void clear_xla_gpu_enable_gpu2_runtime();
  bool xla_gpu_enable_gpu2_runtime() const;
  void set_xla_gpu_enable_gpu2_runtime(bool value);
  private:
  bool _internal_xla_gpu_enable_gpu2_runtime() const;
  void _internal_set_xla_gpu_enable_gpu2_runtime(bool value);
  public:

  // bool xla_gpu_enable_gpu2_hal = 234;
  void clear_xla_gpu_enable_gpu2_hal();
  bool xla_gpu_enable_gpu2_hal() const;
  void set_xla_gpu_enable_gpu2_hal(bool value);
  private:
  bool _internal_xla_gpu_enable_gpu2_hal() const;
  void _internal_set_xla_gpu_enable_gpu2_hal(bool value);
  public:
  ...
  void clear_xla_gpu_single_wave_autotuning();
  bool xla_gpu_single_wave_autotuning() const;
  void set_xla_gpu_single_wave_autotuning(bool value);
  private:
  bool _internal_xla_gpu_single_wave_autotuning() const;
  void _internal_set_xla_gpu_single_wave_autotuning(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    bool xla_gpu_enable_gpu2_runtime_;
    bool xla_gpu_enable_gpu2_hal_;
    ...
    bool xla_gpu_single_wave_autotuning_;
...
class GpuCompilationEnvironment final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:xla.GpuCompilationEnvironment) */ {
 public:
  ...
  inline void CopyFrom(const GpuCompilationEnvironment& from) {
...
// bool xla_gpu_enable_gpu2_runtime = 233;
inline void DebugOptions::clear_xla_gpu_enable_gpu2_runtime() {
  _impl_.xla_gpu_enable_gpu2_runtime_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_enable_gpu2_runtime() const {
  return _impl_.xla_gpu_enable_gpu2_runtime_;
}
inline bool DebugOptions::xla_gpu_enable_gpu2_runtime() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_enable_gpu2_runtime)
  return _internal_xla_gpu_enable_gpu2_runtime();
}
inline void DebugOptions::_internal_set_xla_gpu_enable_gpu2_runtime(bool value) {
  
  _impl_.xla_gpu_enable_gpu2_runtime_ = value;
}
inline void DebugOptions::set_xla_gpu_enable_gpu2_runtime(bool value) {
  _internal_set_xla_gpu_enable_gpu2_runtime(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_enable_gpu2_runtime)
}

// bool xla_gpu_enable_gpu2_hal = 234;
inline void DebugOptions::clear_xla_gpu_enable_gpu2_hal() {
  _impl_.xla_gpu_enable_gpu2_hal_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_enable_gpu2_hal() const {
  return _impl_.xla_gpu_enable_gpu2_hal_;
}
inline bool DebugOptions::xla_gpu_enable_gpu2_hal() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_enable_gpu2_hal)
  return _internal_xla_gpu_enable_gpu2_hal();
}
inline void DebugOptions::_internal_set_xla_gpu_enable_gpu2_hal(bool value) {
  
  _impl_.xla_gpu_enable_gpu2_hal_ = value;
}
inline void DebugOptions::set_xla_gpu_enable_gpu2_hal(bool value) {
  _internal_set_xla_gpu_enable_gpu2_hal(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_enable_gpu2_hal)
}
...
// bool xla_gpu_single_wave_autotuning = 242;
inline void DebugOptions::clear_xla_gpu_single_wave_autotuning() {
  _impl_.xla_gpu_single_wave_autotuning_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_single_wave_autotuning() const {
  return _impl_.xla_gpu_single_wave_autotuning_;
}
inline bool DebugOptions::xla_gpu_single_wave_autotuning() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_single_wave_autotuning)
  return _internal_xla_gpu_single_wave_autotuning();
}
inline void DebugOptions::_internal_set_xla_gpu_single_wave_autotuning(bool value) {
  
  _impl_.xla_gpu_single_wave_autotuning_ = value;
}
inline void DebugOptions::set_xla_gpu_single_wave_autotuning(bool value) {
  _internal_set_xla_gpu_single_wave_autotuning(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_single_wave_autotuning)
}
