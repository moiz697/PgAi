...
# Load the data
df = pd.read_csv('/Users/umerkhurshid/Downloads/weatherAUS.csv')
...
try:
    with open('/Users/umerkhurshid/work/final/Weather_Predictions.pkl', 'rb') as f:
